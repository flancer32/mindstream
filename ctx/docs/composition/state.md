...
Документ фиксирует **допустимые состояния пользовательского опыта** в MVP Mindstream.  
Состояния описываются как устойчивые формы существования опыта чтения и внимания, а не как состояния системы, этапы выполнения или переходы.
...
В рамках MVP не существуют и не считаются допустимыми:
...
- причины возникновения состояний;
- события, сигналы и триггеры;
- архитектурные и вычислительные состояния;
- визуальные механизмы реализации состояний.
