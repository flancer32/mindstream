...
Исключение составляет ручной порог маркировки индикатора интереса, доступный в панели настроек (меню-гамбургер). Правило работы контрола описано в `ctx/docs/composition/attention/threshold-control.md`.
