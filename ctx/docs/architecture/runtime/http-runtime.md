...
HTTP-runtime-граница обеспечивает исполнение HTTP Ingress и фиксируется как runtime-часть соответствующей архитектурной границы. Связанный документ: `ctx/docs/architecture/ingress/http-ingress.md`.
