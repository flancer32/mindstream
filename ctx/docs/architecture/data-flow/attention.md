...
- носят статистический, а не управляющий характер;
- не участвуют в формировании корпуса данных.
...
- не интерпретируются во времени;
- не образуют причинных цепочек;
- не инициируют немедленных вычислений в серверных контурах;
- накапливаются как статистические наблюдения.
