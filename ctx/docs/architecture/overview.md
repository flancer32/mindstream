...
Формирует и использует interest vector как локальную производную, применяемую при вычислении персональной ленты. Источник interest vector зависит от режима доступа пользователя. Модель формирования и интерпретации interest vector зафиксирована в документе `attention/interest-vector.md`.
