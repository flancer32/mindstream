...
В рамках MVP Mindstream источник публикаций (`Source`) рассматривается как минимальный ingress-идентификатор и связанный с ним провайдер доступа и идентификации, а не как наблюдаемая или управляемая сущность.
